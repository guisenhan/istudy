 ...
 */
public abstract class MyCropImageView extends TransformImageView {
        ...
        if (!isImageWrapCropBounds()) {
            ...
            if (animate) {
                post(mWrapCropBoundsRunnable = new WrapCropBoundsRunnable(
                        MyCropImageView.this, mImageToWrapCropBoundsAnimDuration, currentX, currentY, deltaX, deltaY,
    ...
    protected void zoomImageToPosition(float scale, float centerX, float centerY, long durationMs) {
        ...
        post(mZoomImageToPositionRunnable = new ZoomImageToPosition(MyCropImageView.this,
    ...
    private static class WrapCropBoundsRunnable implements Runnable {
        ...
        private final WeakReference<MyCropImageView> mCropImageView;
        ...
        public WrapCropBoundsRunnable(MyCropImageView cropImageView,
                long durationMs,
        ...
        @Override
        public void run() {
            MyCropImageView cropImageView = mCropImageView.get();
    ...
    private static class ZoomImageToPosition implements Runnable {
        ...
        public ZoomImageToPosition(MyCropImageView cropImageView,
                long durationMs,
                float oldScale, float deltaScale,
