 ...
 */
public class MyGestureCropImageView extends MyCropImageView {
    ...
    public MyGestureCropImageView(Context context) {
        super(context);
    }

    public MyGestureCropImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MyGestureCropImageView(Context context, AttributeSet attrs, int defStyle) {
